            ...
            >
              <TiltCard tiltAmount={5} className="h-full">
                <SpotlightCard
                  ...
                  className={`bg-card rounded-2xl clean-border p-8 gentle-animation cursor-default h-full`}
                >
                  {/* Top accent line */}
                  <div className={`absolute top-0 left-8 right-8 h-0.5 rounded-full bg-${cap.color} opacity-0 group-hover:opacity-100 gentle-animation`} />
