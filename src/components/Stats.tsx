...
const stats = [
  { icon: Clock, value: '75%', label: 'Reduction in Screening Time', description: 'Automate hours of manual resume review with AI-powered analysis.' },
  { icon: Target, value: '95%', label: 'Matching Accuracy', description: 'Semantic similarity outperforms keyword matching in identifying qualified candidates.' },
  { icon: TrendingDown, value: '60%', label: 'Lower Cost-per-Hire', description: 'Streamlined screening reduces recruiter workload and accelerates decisions.' },
  { icon: Scale, value: '100%', label: 'Transparent Scoring', description: 'Every ranking is explainable with detailed skill breakdowns and gap analysis.' },
]
