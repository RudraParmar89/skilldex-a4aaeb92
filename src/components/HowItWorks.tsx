      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-foreground">
            From Upload to <span className="gradient-text">Insight</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {steps.map((step, i) => (
              <motion.div
                ...
                className="relative bg-card rounded-2xl clean-border p-8 hover:card-shadow gentle-animation group"
              >
                {/* Step number */}
                <div className={`absolute -top-4 -left-4 w-12 h-12 ${step.color} rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg`}>
                  {step.number}
                </div>
